...
PYBIND11_MODULE( sconepy, m ) {
	...
	py::class_<scone::Model>( m, "Model" )
		...
		.def( "init_muscle_activations", &scone::init_muscle_activations, "Initialize all muscle activations" )
		...
		.def( "current_measure", &scone::Model::GetCurrentMeasureResult, "Get the Measure value of this Model" )
		.def( "final_measure", &scone::Model::GetMeasureResult, "Get the final measure of this Model" )
		.def( "log_measure_report", []( scone::Model& m ) { return scone::log_measure_report( m ); }, "Log the Measure report" )
		.def( "set_control_parameter", &scone::set_control_parameter, "Set a control parameter" )
		.def( "get_control_parameter", &scone::get_control_parameter, "Get the value of a control parameter" )
		.def( "get_control_parameter_names", &scone::get_control_parameter_names, "Get a list of all parameter names in this Model" )
