...
PYBIND11_MODULE( sconepy, m ) {
	...
	py::class_<scone::Joint>( m, "Joint" )
		...
		.def( "load", &scone::Joint::GetLoad, "Get the scalar joint load" )
	...
	py::class_<scone::Model>( m, "Model" )
		...
		.def( "com_pos", &scone::Model::GetComPos, "Get the com_pos of this Model" )
		.def( "com_vel", &scone::Model::GetComVel, "Get the com_vel of this Model" )
		.def( "mass", &scone::Model::GetMass, "Get the mass of this Model" )
		.def( "gravity", &scone::Model::GetGravity, "Get the gravity of this Model" )
		.def( "contact_force", &scone::Model::GetTotalContactForce, "Get the contact_force applied to this Model" )
		.def( "contact_load", []( scone::Model& m ) { return m.GetTotalContactForce() / m.GetBW(); }, "Get the contact_load applied to this Model" )
		.def( "contact_power", &scone::Model::GetTotalContactPower, "Get the contact_power of this Model" )
		...
		.def( "measure", []( scone::Model& m ) { return m.GetMeasure(); }, py::return_value_policy::reference, "Get the Measure of this Model" )
		.def( "set_dof_positions", &scone::set_dof_positions, "Set the dof_positions for this Model" )
		.def( "set_dof_velocities", &scone::set_dof_velocities, "Set the dof_velocities for this Model" )
		.def( "init_state_from_dofs", []( scone::Model& m ) { m.InitStateFromDofs(); }, "Get the init_state_from_dofs of this Model" )
		.def( "adjust_state_for_load", &scone::Model::AdjustStateForLoad, "Get the adjust_state_for_load of this Model" )
		.def( "set_actuator_inputs", &scone::set_actuator_inputs, "Set the actuator_inputs for this Model" )
		.def( "actuator_input_array", []( scone::Model& m ) { return scone::get_actuator_inputs( m, g_f32 ); }, "Get the actuator_input_array of this Model" )
		.def( "dof_position_array", []( scone::Model& m ) { return scone::get_dof_positions( m, g_f32 ); }, "Get the dof_position_array of this Model" )
		.def( "dof_velocity_array", []( scone::Model& m ) { return scone::get_dof_velocities( m, g_f32 ); }, "Get the dof_velocity_array of this Model" )
		.def( "muscle_fiber_length_array", []( scone::Model& m ) { return scone::get_muscle_lengths( m, g_f32 ); }, "Get the muscle_fiber_length_array of this Model" )
		.def( "muscle_fiber_velocity_array", []( scone::Model& m ) { return scone::get_muscle_velocities( m, g_f32 ); }, "Get the muscle_fiber_velocity_array of this Model" )
		.def( "muscle_force_array", []( scone::Model& m ) { return scone::get_muscle_forces( m, g_f32 ); }, "Get the muscle_force_array of this Model" )
		.def( "muscle_activation_array", []( scone::Model& m ) { return scone::get_muscle_activations( m, g_f32 ); }, "Get the muscle_activation_array of this Model" )
		.def( "muscle_excitation_array", []( scone::Model& m ) { return scone::get_muscle_excitations( m, g_f32 ); }, "Get the muscle_excitation_array of this Model" )
		.def( "delayed_muscle_fiber_length_array", []( scone::Model& m ) { return get_delayed_sensor_array( m, SensorType::Length, g_f32 ); }, "Get the delayed_muscle_fiber_length_array of this Model" )
		.def( "delayed_muscle_fiber_velocity_array", []( scone::Model& m ) { return get_delayed_sensor_array( m, SensorType::Velocity, g_f32 ); }, "Get the delayed_muscle_fiber_velocity_array of this Model" )
		.def( "delayed_muscle_force_array", []( scone::Model& m ) { return get_delayed_sensor_array( m, SensorType::Force, g_f32 ); }, "Get the delayed_muscle_force_array of this Model" )
		.def( "delayed_dof_position_array", []( scone::Model& m ) { return get_delayed_sensor_array( m, SensorType::DofPos, g_f32 ); }, "Get the delayed_dof_position_array of this Model" )
		.def( "delayed_dof_velocity_array", []( scone::Model& m ) { return get_delayed_sensor_array( m, SensorType::DofVel, g_f32 ); }, "Get the delayed_dof_velocity_array of this Model" )
		.def( "delayed_vestibular_array", []( scone::Model& m ) { return get_delayed_sensor_array( m, SensorType::Vestibular, g_f32 ); }, "Get the delayed_vestibular_array of this Model" )
		.def( "set_delayed_actuator_inputs", &scone::set_delayed_actuator_inputs, "Set the delayed_actuator_inputs for this Model" )
		.def( "init_muscle_activations", &scone::init_muscle_activations, "Get the init_muscle_activations of this Model" )
		.def( "advance_simulation_to", &scone::Model::AdvanceSimulationTo, "Get the advance_simulation_to of this Model" )
		.def( "reset", &scone::Model::Reset, "Get the reset of this Model" )
		.def( "time", &scone::Model::GetTime, "Get the time of this Model" )
		.def( "set_simulation_end_time", &scone::Model::SetSimulationEndTime, "Set the simulation_end_time for this Model" )
		.def( "has_simulation_ended", &scone::Model::HasSimulationEnded, "Get the has_simulation_ended of this Model" )
		.def( "current_measure", &scone::Model::GetCurrentMeasureResult, "Get the current_measure of this Model" )
		.def( "final_measure", &scone::Model::GetMeasureResult, "Get the final_measure of this Model" )
		.def( "log_measure_report", []( scone::Model& m ) { return scone::log_measure_report( m ); }, "Get the log_measure_report of this Model" )
		.def( "set_control_parameter", &scone::set_control_parameter, "Set the control_parameter for this Model" )
		.def( "get_control_parameter", &scone::get_control_parameter, "Get the get_control_parameter of this Model" )
		.def( "get_control_parameter_names", &scone::get_control_parameter_names, "Get the get_control_parameter_names of this Model" )
		.def( "integration_step", &scone::Model::GetIntegrationStep, "Get the integration_step of this Model" )
		.def( "control_step_size", []( scone::Model& m ) { return m.fixed_control_step_size; }, "Get the control_step_size of this Model" )
		.def( "set_store_data", &scone::Model::SetStoreData, "Set the store_data for this Model" )
		.def( "get_store_data", &scone::Model::GetStoreData, "Get the get_store_data of this Model" )
		.def( "write_results", &scone::write_results, "Get the write_results of this Model" )
		;
