...
PYBIND11_MODULE( sconepy, m ) {
	...
	py::class_<scone::Body>( m, "Body" )
		...
		.def( "pos", &scone::Body::GetOriginPos, "Get the position of the Body origin" )
		.def( "vel", &scone::Body::GetOriginVel, "Get the velocity of the Body origin" )
		.def( "acc", &scone::Body::GetOriginAcc, "Get the acceleration of the Body origin" )
		...
		.def( "local_com_pos", &scone::Body::GetLocalComPos, "Get the com offset of this Body in the local coordinate frame" )
		.def( "local_pos", &scone::Body::GetLocalPosOfPoint, "Get the local position of a point in the world coordinate frame" )
		...
		.def( "has_parent", &scone::Body::HasParent, "Get if this Body has a parent Joint" )
		...
		.def( "set_com_pos", &scone::Body::SetComPos, "Set the center-of-mass position of this Body" )
	...
	py::class_<scone::Muscle>( m, "Muscle" )
		...
		.def( "mass", &scone::Muscle::GetMass, py::arg() = 0.25e6, py::arg() = 1059.7, "Get the mass of the Muscle for a specific tension and density" )
		.def( "pcsa", &scone::Muscle::GetPCSA, py::arg() = 0.25e6, "Get the PCSA of the Muscle for a specific tension" )
		.def( "volume", &scone::Muscle::GetVolume, py::arg() = 0.25e6, "Get the volume of the Muscle for a specific tension" )
