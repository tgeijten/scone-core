...
namespace scone
{
	void register_lua_wrappers( sol::state& lua )
	{
		...
		lua.new_usertype<LuaBody>( "LuaBody", sol::constructors<>(),
			...
			"local_com_pos", &LuaBody::local_com_pos,
		...
		lua.new_usertype<LuaJoint>( "LuaJoint", sol::constructors<>(),
			...
			"muscle_moment", &LuaJoint::muscle_moment,
			"load", &LuaJoint::load,
		...
		lua.new_usertype<LuaMuscle>( "LuaMuscle", sol::constructors<>(),
			...
			"dof_moment", &LuaMuscle::dof_moment,
			"dof_moment_arm", &LuaMuscle::dof_moment_arm,
			"joint_moment", &LuaMuscle::joint_moment,
			"joint_moment_arm", &LuaMuscle::joint_moment_arm,
		...
		lua.new_usertype<LuaModel>( "LuaModel", sol::constructors<>(),
			...
			"contact_force", &LuaModel::contact_force,
			"contact_power", &LuaModel::contact_power,
			"ground_reaction_force", &LuaModel::ground_reaction_force,
			"self_contact_force", &LuaModel::self_contact_force,
