...
**License text:** [licenses/pybind11-BSD-3-Clause.txt](./licenses/pybind11-BSD-3-Clause.txt)
...
| License | Libraries |
|----------|------------|
| Apache License 2.0 | SCONE, OpenSim 3.3, OpenSim 4.3, Simbody, xo, spot |
...
- `NOTICE` files from **OpenSim 3.3** and **OpenSim 4.3** are preserved verbatim.  
- Apache-licensed components without NOTICE files (Simbody, xo, spot) are acknowledged via this document and the included license text.  
- The BSD 3-Clause license for **pybind11** requires inclusion of its copyright and disclaimer text, which is provided in `licenses/pybind11-BSD-3-Clause.txt`.  
